...
class SummaryController extends Controller
{
    ...
    public function actionIndex($id = null)
    {
       ...
       $providers = [
        'production' => new ArrayDataProvider([
            'allModels'  => $production,
            'pagination' => ['pageSize'=>20, 'pageParam'=>'production-page'],
        ]),
        'revenue' => new ArrayDataProvider([
            'allModels'  => $revenue,
            'pagination' => ['pageSize'=>20, 'pageParam'=>'revenue-page'],
        ]),
        'feed' => new ArrayDataProvider([
            'allModels'  => $feedWeekly,
            'pagination' => ['pageSize'=>15, 'pageParam'=>'feed-page'],
        ]),
        'costs' => new ArrayDataProvider([
            'allModels'  => $costsAgg,
            'pagination' => ['pageSize'=>15, 'pageParam'=>'costs-page'],
        ]),
        'prices' => new ArrayDataProvider([
            'allModels'  => $prices,
            'pagination' => ['pageSize'=>15, 'pageParam'=>'prices-page'],
        ]),
        'cull' => new ArrayDataProvider([
            'allModels'  => $cull,
            'pagination' => false, // no paging
        ]),
    ];
